...
#Normalization, used for 3_3, 4_3, 5_3
...
class s3fd_original(nn.Module):
    def __init__(self,num_class):
        ...
        #self.conv3_3_norm_gender = nn.Conv2d(256, 4, kernel_size=3, stride=1, padding=1)
        ...
        self.fc7_mbox_gender = nn.Conv2d(1024, 2, kernel_size=3, stride=1, padding=1)
        
        self.conv6_2_mbox_conf = nn.Conv2d(512, 2, kernel_size=3, stride=1, padding=1)
        self.conv6_2_mbox_loc  = nn.Conv2d(512, 4, kernel_size=3, stride=1, padding=1)
        self.conv6_2_mbox_gender = nn.Conv2d(512, 2, kernel_size=3, stride=1, padding=1)
        
        self.conv7_2_mbox_conf = nn.Conv2d(256, 2, kernel_size=3, stride=1, padding=1)
        self.conv7_2_mbox_loc  = nn.Conv2d(256, 4, kernel_size=3, stride=1, padding=1)
    #self.conv7_2_mbox_gender = nn.Conv2d(256, 2, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, x):
        ...
        gen4 = self.fc7_mbox_gender(ffc7)
        
        cls5 = self.conv6_2_mbox_conf(f6_2)
        reg5 = self.conv6_2_mbox_loc(f6_2)
        gen5 = self.conv6_2_mbox_gender(f6_2)
        
        cls6 = self.conv7_2_mbox_conf(f7_2)
        reg6 = self.conv7_2_mbox_loc(f7_2)
        #gen6 = self.conv7_2_mbox_gender(f7_2)
        
        
        #max-out background label
        chunk = torch.chunk(cls1,4,1)
        bmax  = torch.max(torch.max(chunk[0],chunk[1]),chunk[2])
        #Concatenates tensor to a specific form, max out BG label
        ...
        #return [gen2,gen3,gen4,gen5]
#return [cls1,gen1,cls2,gen2,cls3,gen3,cls4,gen4,cls5,gen5,cls6,gen6]
